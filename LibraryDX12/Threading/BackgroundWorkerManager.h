...
///
/// Manager creates N threads where N is number of hardware threads supported by current platform.
...
///
/// When BackgroundWorkerManager is destroyed, it clears the queue (discarding all undone tasks), sets
