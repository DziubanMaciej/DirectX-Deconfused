...
protected:
    void recordGpuUploadCommands(ID3D12DevicePtr device, CommandList &commandList, const void *data, UINT bufferSize, D3D12_RESOURCE_STATES resourceStateToTransition);
